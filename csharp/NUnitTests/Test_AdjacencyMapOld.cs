...
public class Test_AdjacencyMapOld
{
    [SetUp]
    public void Setup()
    {
    ...
    public void Test_DataManipulation_Units()
    {
        ...
        // Assert.That(map, Is.EqualTo(existingNode?.MapOld));
...
//
//         Assert.IsFalse(new List<AdjacencyMapNodeOld<int>?>{node0, node1, node2, node3, node4, node5, node6}.Any(x => x is null));
//
