CREATE TABLE util_employees (
   ...
   junk          CHAR(1000)            ,
   CONSTRAINT util_employees_pk PRIMARY KEY (employee_id)
);
...
END;
$$ LANGUAGE plpgsql;
INSERT INTO util_employees (employee_id,  first_name,
...
UPDATE util_employees
   SET first_name='MARKUS',
       last_name='WINAND'
 WHERE employee_id=123;
VACUUM ANALYZE util_employees;